...
const out22 = document.querySelector(".out-2");
btn2.onclick = f2;
...
const out23 = document.querySelector(".out-3");
btn3.onclick = f3;
...
const out24 = document.querySelector(".out-4");
btn4.onclick = f4;
...
const out26 = document.querySelector(".out-6");
...
out6.innerHTML = result; //передаємо тег тому інер
...
const out27 = document.querySelector(".out-7);
...
function fn11() {
  const divs11 = document.querySelector(".div-11");
  let result = "";
...
// 2 variant spysaty u screenchot 15.01
...
function fn14() {
  const radios = document.querySelector(".i-14");
  const out14 = document.querySelector(".out-14");
  

  for (let i = 0; i < radios.length; i++) {
     if (radios[i].checked) {
      out14.innerHTML = radios[i].value;
      return;
     }
